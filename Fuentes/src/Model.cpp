...
void Model::Initialize(Vertex3 vertices[], GLint length, std::string strVertex,
	...
	glVertexAttribPointer(kColorIndex, 4, GL_FLOAT, GL_FALSE,
	...
	if (ErrorCheckValue != GL_NO_ERROR) {
		...
		fprintf(stderr,
				"ERROR: Could not create a VAO and VBO with error Id: %d\n",
				ErrorCheckValue);
		exit(-1);
	}
}
