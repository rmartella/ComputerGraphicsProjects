#include "Headers/ModelEnvironment.h"
 ...
 */
void ModelEnvironment::Initialize(Vertex3 vertices[], GLuint indexData[],
                                 int length, int indexLength,
 ...
 */
void ModelEnvironment::Render(mat4 parentModelMatrix) {
 ...
 */
GLint ModelEnvironment::GetVariable(std::string strVariable) {
